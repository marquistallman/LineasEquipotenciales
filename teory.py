...
# Potenciales
V[circle] = 20   # voltaje máximo (ajústalo si usaste otro)
V[barra] = 0
...
# Todas las equipotenciales (suaves)
plt.contour(X, Y, V, levels=30, alpha=0.4)

# Equipotenciales IMPORTANTES (las del experimento)
...
plt.title("Líneas equipotenciales (2, 5, 10, 15, 18 V) y campo eléctrico")
plt.xlabel("cm")
plt.ylabel("cm")
plt.axis("equal")
